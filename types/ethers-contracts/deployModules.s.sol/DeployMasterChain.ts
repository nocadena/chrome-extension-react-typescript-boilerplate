...
export interface DeployMasterChainInterface extends utils.Interface {
  functions: {
...
export interface DeployMasterChain extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMasterChainInterface;
