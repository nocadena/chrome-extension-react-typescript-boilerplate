...
export interface DeploySatelliteChainInterface extends utils.Interface {
  functions: {
...
export interface DeploySatelliteChain extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeploySatelliteChainInterface;
