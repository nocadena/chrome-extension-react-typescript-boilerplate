...
export interface InitCommunicatorInterface extends utils.Interface {
  functions: {
...
export interface InitCommunicator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InitCommunicatorInterface;
